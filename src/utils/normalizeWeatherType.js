export function normalizeWeatherType(code, text = "") {
  ...
  if ([1087, 1273, 1276, 1279, 1282].includes(normalizedCode)) return "Thunderstorm";

  // heavy rain must be above rain to avoid being shadowed
  if ([1192, 1195, 1243, 1246].includes(normalizedCode)) return "Heavy Rain";
  if ([1063, 1180, 1183, 1186, 1189, 1240].includes(normalizedCode)) return "Rain";

  if ([1066, 1069, 1072, 1114, 1117, 1204, 1207, 1210, 1213, 1216, 1219, 1222, 1225, 1237, 1249, 1252, 1255, 1258, 1261, 1264].includes(normalizedCode)) {
    return "Snow";
  }
